        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    databseId = table.Column<int>(type: "int", nullable: false),
                    databseFieldId = table.Column<int>(type: "int", nullable: false),
                    FK_teacherId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FK_departmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subtitles_Videos_FK_videoId",
                        column: x => x.FK_videoId,
                        principalTable: "Videos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
